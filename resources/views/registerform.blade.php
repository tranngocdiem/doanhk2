  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <form method="post" action="#" id="registerform">
                ...
                <input class="form-control" id="txttaikhoan" type="text"  placeholder="Nhập tên đăng nhập"name ="tentaikhoan" >
                <label >Mật khẩu</label>
                <input class="form-control" id="txtmatkhau" type="password" placeholder="Nhập mật khẩu" name="matkhau" >
                ...
                <input class="form-control" id="txtname" type="text" placeholder="Nhập tên" name="name" 
                 > 
                <label >Địa chỉ</label>
                <input class="form-control" id="txtaddress" type="text"  placeholder="Nhập địa chỉ" name="address">
